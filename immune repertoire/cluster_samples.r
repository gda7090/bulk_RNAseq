#args <- c("out/4.intersect.batch.aa.txt", "1", "2", "17", "0", "25", "26", "0", "0", "tag1", "F", "out/4.tag1.hc.aa.F.pdf", "out/4.tag1.mds.aa.F.pdf", "T", "out/4.tag1.hc.aa.F.newick.txt", "out/4.tag1.mds.aa.F.txt")
